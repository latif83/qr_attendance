...
export default function Home() {
  ...
  return (
    <div className="h-screen relative">
      <div
        className={`bg-green-700 absolute top-0 left-0 w-full ${styles.banner}`}
        style={{ height: "50%" }}
      ></div>
      <div className="relative z-50 flex justify-center items-center w-full h-full">
        <div class="w-full bg-white overflow-hidden rounded-lg border-2 border-green-700 shadow md:mt-0 sm:max-w-md xl:p-0 sm:mx-0 mx-3">
          <a
            href="#"
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action={submit}>
              ...
              <button
                type="submit"
                disabled={loading}
                class="w-full text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 disabled:bg-green-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
                    {" "}
